                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li><a href="{{route('cart')}}">Cart<i class="ti-arrow-right"></i></a></li>
                                            ...
                                            <li class="shipping">
                                                ...
                                                @if(count(Helper::shipping())>0 && Helper::cartCount()>0)
                                                    <select name="shipping" class="nice-select">
                                                        <option value="">Select your Courir</option>
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            ...
                                            <form-group>
                                                ...
                                                <input name="payment_method"  type="radio" value="paypal" disabled> <label> PayPal</label>
                                            </form-group>
